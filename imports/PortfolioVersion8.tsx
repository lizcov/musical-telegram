import svgPaths from "./svg-g4k9eflhdk";
...
function Button1() {
  return (
    <div className="bg-[#470068] box-border content-stretch flex gap-[10px] items-center justify-center px-[24px] py-[16px] relative rounded-[12px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[0.5px] border-solid border-white inset-0 pointer-events-none rounded-[12px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.3),0px_1px_3px_1px_rgba(0,0,0,0.15)]" />
...
function Butterfly() {
  return (
    <div className="absolute h-[63px] left-[calc(91.667%+26.667px)] top-[409px] w-[69px]" data-name="Butterfly 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 69 63">
        <g clipPath="url(#clip0_1_110)" id="Butterfly 1">
          <path d={svgPaths.p28d69c00} fill="url(#paint0_linear_1_110)" id="Vector" />
          <path d={svgPaths.p3be78110} fill="url(#paint1_linear_1_110)" id="Vector_2" />
          <path d={svgPaths.p3e27ca00} fill="url(#paint2_linear_1_110)" id="Vector_3" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_110" x1="-5.5" x2="38.8678" y1="26.5563" y2="16.4038">
            <stop stopColor="#A45DC2" />
            <stop offset="1" stopColor="#7700A7" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_1_110" x1="39" x2="1.67221" y1="33.0563" y2="43.8369">
            <stop stopColor="#7700A7" />
            <stop offset="1" stopColor="#A45DC2" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_1_110" x1="8.5" x2="63.2812" y1="36.9437" y2="53.2147">
            <stop stopColor="#A45DC2" />
            <stop offset="1" stopColor="#7700A7" />
          </linearGradient>
          <clipPath id="clip0_1_110">
            <rect fill="white" height="63" width="69" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function SectionHeader() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[8px] h-[128px] items-center justify-center pb-[20px] pt-0 px-0 relative rounded-tl-[40px] rounded-tr-[40px] shrink-0 text-[#222222] w-full" data-name="Section Header">
...
function Projects() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full" data-name="Projects">
      <SectionHeader />
      <Bottom />
    </div>
  );
...
function ToggleButton1() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[8px] items-center left-[calc(83.333%+26.333px)] px-[24px] py-[16px] rounded-[26.667px] top-[713px]" data-name="Toggle Button">
...
export default function PortfolioVersion() {
  return (
    <div className="relative size-full" data-name="Portfolio Version 8" style={{ backgroundImage: "linear-gradient(221.423deg, rgba(71, 0, 104, 0.2) 12.194%, rgba(255, 255, 255, 0.15) 8.8336%, rgba(255, 255, 255, 0.1) 55.82%, rgba(71, 0, 104, 0.2) 106.86%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <div className="size-full">
